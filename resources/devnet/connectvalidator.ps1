...
if ($RpcPort -gt 0) {
    ...
    $rpcArgs = @("--http", "--http.port", "$RpcPort", "--http.api", "eth,net,web3,personal", "--allow-insecure-unlock")
}
.\dp --datadir data --networkid 123123 --syncmode full --gcmode full --freezermode skipappend --unlock $env:DC_ACC_ADDRESS --mine @rpcArgs
