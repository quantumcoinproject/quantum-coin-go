...
func (n *pmp) AddMapping(protocol string, extport, intport int, name string, lifetime time.Duration) error {
	...
	// Upstream 42212808f: NAT-PMP maps an alternative available port number if the
	// requested port is already mapped to another address and returns success. In this
