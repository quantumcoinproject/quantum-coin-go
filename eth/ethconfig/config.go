...
type Config struct {
	...
	// HTTP sync: optional HTTP server for block/header download. Clients use P2P peers (30303) and assume HTTP sync on 30304.
	HttpSyncListen bool `toml:",omitempty"` // Enable HTTP sync server (listen on port 30304)
}
