...
func testHybridEddsaMldsaSlhdsaSigBasic(t *testing.T) {
	...
	sig = CreateHybridEddsaMldsaSlhdsaSig()
...
func TestHybridEddsaMldsaSlhdsaSeed(t *testing.T) {
	var seed [hybridedmldsaslhdsa.SeedSize]byte
	for i := byte(0); i < hybridedmldsaslhdsa.SeedSize; i++ {
		seed[i] = i
	}
...
func testCompactFull(t *testing.T) {
	...
	sigCompact = CreateHybridEddsaMldsaSlhdsaSig()
	sigFull = hybrideddsamldsaslhdsafull.CreateHybridEddsaMldsaSlhdsaFullSig()
...
func TestHybridEddsaMldsaSlhdsaSig_Compact_Full(t *testing.T) {
	testCompactFull(t)
}
...
func TestGenerateKeyFromPreExpansionSeed(t *testing.T) {
	var preExpansionSeed [hybridedmldsaslhdsa.BaseSeedSize]byte
	for i := 0; i < hybridedmldsaslhdsa.BaseSeedSize; i++ {
	...
	addr := crypto.PublicKeyBytesToAddress(pKey.PubData)
	expected := common.HexToAddress("0xa97C6Fc4AB5cfA4c51691E6Cce73b98b628cC27c612748d17909927e71139401")
