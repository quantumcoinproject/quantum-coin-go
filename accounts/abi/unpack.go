...
//
// Upstream cefc0fa00: decoding is stringent. Previously only the trailing bytes
// of the word were read, so a value too wide for the declared type was silently
