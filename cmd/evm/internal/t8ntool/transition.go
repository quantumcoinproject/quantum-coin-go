...
// OnAccount takes a *common.Address so that an account whose preimage is unknown can be
// reported as nil rather than silently collapsing onto the zero address. Upstream bfded65ed.
