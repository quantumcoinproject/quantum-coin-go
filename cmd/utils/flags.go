...
import (
	...
	"github.com/quantumcoinproject/quantum-coin-go/common/fdlimit"
	...
	"github.com/quantumcoinproject/quantum-coin-go/ethstats"
	"github.com/quantumcoinproject/quantum-coin-go/graphql"
	...
	"github.com/quantumcoinproject/quantum-coin-go/metrics/influxdb"
...
var (
	...
	KeyTypeFlag = cli.IntFlag{
		Name:  "keytype",
		Usage: "SigAlg type, should be between 0 t0 5 (0 to 4 produces same key type)",
	}
...
func RegisterEthService(stack *node.Node, cfg *ethconfig.Config) (ethapi.Backend, *eth.Ethereum) {
	...
	if err != nil {
		Fatalf("Failed to register the QuantumCoin service: %v", err)
	}
...
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := ethstats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the QuantumCoin Stats service: %v", err)
	}
}
