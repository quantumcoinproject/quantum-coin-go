...
var (
	...
	sigtest, _     = cryptobase.DynamicSign.Sign(hash1.Bytes(), privtestkey)
	...
	sigtest2, _ = cryptobase.DynamicSign.Sign(hash2.Bytes(), privtestkey)
...
func defaultTestKey() (*signaturealgorithm.PrivateKey, common.Address, error) {
	key, err := cryptobase.SigAlg.HexToPrivateKey(hextestkey)
	if err != nil {
