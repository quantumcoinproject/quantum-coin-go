...
func TestDeriveFields(t *testing.T) {
	...
	err := rlp.Encode(buff, receipts)
	if err != nil {
		t.Fatal("Encode error: ", err)
	}
	receiptsBlob := buff.Bytes()
	fmt.Println("receipts blob", common.Bytes2Hex(receiptsBlob))
...
func TestTypedReceiptEncodingDecoding(t *testing.T) {
	var payload = common.FromHex("")
	check := func(bundle []*Receipt) {
		t.Helper()
		for i, receipt := range bundle {
			if got, want := receipt.Type, uint8(DefaultFeeTxType); got != want {
